<%-- 
    Document   : acerca
    Created on : 2023 Jul 10, 00:45:11
    Author     : Nestor
--%>
...
<head>
    ...
    <title>Registro de Documentación / Acerca de </title>
...
<body>
    <header>
        ...
        <div class="container">        
            <div class="acerca">
                <h1>Trabajo desarrollado para TBBSA</h1>
                <h2>En el marco de Seminario de trabajos</h2>
                <a href="index.jsp">Regresar</a>
                            
            </div>
            
            <!-- <img src="img/imagen.png" alt="">  comment -->
