<%-- 
    Document   : sectorEliminar
    Created on : 2023 Jul 11, 01:49:36
    Author     : Nestor
--%>
                    ...
                    <div class="col-md-6 mt-1 row-cols-1">
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title">Elimina Sector</h3>
                            </div>
                        
                        <!-- form start -->
                        <!--        
                        <form name="formSector" action="ServletBuscarSector" method="POST" >
                        -->
                        ...
                        <form name="formSector" action="ServletBorrarSector" method="POST" >
                            ...
                            <div class="card-body ">
                                ...
                                <div class="input-group-append">
                                    <a action="menuprincipal.jsp"  href="menuprincipal.jsp" type="submit" class="btn btn-primary" >Cancelar</a>
                                    <p> </p>
                                    <button type="submit" class="btn disabled btn-danger">Eliminar</button>
                                </div>
                    ...
                    <table id="tablaSector" class="table table-head-fixed text-nowrap table-bordered table-active table-striped" height="45" >
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <a href="sectorEliminar_1.jsp?idSector=<%=sect.getIdSector()%>" id="IdBorrar" class="btn icon btn-danger btn-xs" >Eliminar</a>
                                </td>
