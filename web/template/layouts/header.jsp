<%-- 
    Document   : header
    Created on : 2023 Jul 26, 21:19:52
    Author     : Nestor
--%>
                    ...
                    <nav class="mt-2">
                        <ul class="nav nav-pills nav-sidebar nav-compact nav-child-indent nav-legacy flex-column" data-widget="treeview" role="menu" data-accordion="false">
                            ...
                            <li class="nav-item  font-weight-bold">
                                ...
                                <ul class="nav nav-treeview font-weight-normal">
                                    <li class="nav-item">
                                        <a href="licenciasAltas.jsp" class="nav-link">
                            ...
                            <li class="nav-item">
                                ...
                                <ul class="nav nav-treeview">
                                    ...
                                    <li class="nav-item">
                                        <a href="sectorEditar.jsp" class="nav-link">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>Modificaciones</p>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="sectorEliminar.jsp" class="nav-link">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>Bajas</p>
                                        </a>
                                    </li>
